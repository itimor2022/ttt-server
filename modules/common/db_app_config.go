...
type appConfigModel struct {
	...
	MomentsOff                     int    // 是否隐藏朋友圈入口 1:隐藏 0:显示
	AIInvestUrl                    string // AI智投链接
	InsightUrl                     string // 洞察链接
	AIInvestOn                     int    // AI智投开关 1:开启 0:关闭
	InsightConnectionOn            int    // 洞察连接开关 1:开启 0:关闭
	NormalUserCanAddFriend         int    // 普通用户是否可以添加好友 1:可以 0:不可以
	ldb.BaseModel
}
